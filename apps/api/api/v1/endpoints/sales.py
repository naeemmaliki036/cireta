...
def _sale_to_response(
    ...
    return SaleResponse(
        ...
        sale_mode=sale.sale_mode.value if hasattr(sale.sale_mode, "value") else (sale.sale_mode or "vested"),
        ...
        platform_fee_bps=getattr(sale, "platform_fee_bps", 250) or 250,
        fee_cap_usdc=str(sale.fee_cap_usdc) if getattr(sale, "fee_cap_usdc", None) is not None else None,
