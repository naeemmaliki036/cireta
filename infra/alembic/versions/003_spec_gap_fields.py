...
def upgrade() -> None:
    ...
    op.add_column(
        "users",
        sa.Column("investor_type", sa.String(20), server_default="individual", nullable=False),
    )
    ...
    op.add_column(
        "wallets", sa.Column("is_safe", sa.Boolean(), server_default="false", nullable=False)
    )
    op.add_column(
        "wallets",
        sa.Column("registered_on_chain", sa.Boolean(), server_default="false", nullable=False),
    )
    ...
    op.add_column(
        "token_sales",
        sa.Column(
            "total_raised_on_platform", sa.Numeric(36, 6), server_default="0", nullable=False
        ),
    )
    op.add_column(
        "token_sales",
        sa.Column("platform_fee_collected", sa.Numeric(36, 6), server_default="0", nullable=False),
    )
    op.add_column("token_sales", sa.Column("contract_address", sa.String(42), nullable=True))
    op.add_column(
        "token_sales", sa.Column("finalized_at", sa.DateTime(timezone=True), nullable=True)
    )

    # ── contributions: OTC fields ──────────────────────────────────────────
    op.add_column(
        "contributions", sa.Column("is_otc", sa.Boolean(), server_default="false", nullable=False)
    )
    ...
    op.add_column(
        "contributions", sa.Column("phase_index", sa.Integer(), server_default="0", nullable=False)
    )
    ...
    op.add_column(
        "redemption_requests", sa.Column("shipped_at", sa.DateTime(timezone=True), nullable=True)
    )

    # ── issuers: whitelist tracking ────────────────────────────────────────
    op.add_column("issuers", sa.Column("whitelisted_at", sa.DateTime(timezone=True), nullable=True))
    op.add_column(
        "issuers", sa.Column("whitelisted_by", postgresql.UUID(as_uuid=True), nullable=True)
    )
    op.create_foreign_key(
        "fk_issuers_whitelisted_by",
        "issuers",
        "users",
        ["whitelisted_by"],
        ["id"],
